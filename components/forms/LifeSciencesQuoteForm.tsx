...
export default function LifeSciencesQuoteForm({
  ...
  const validateForm = (): boolean => {
    ...
    // Always required: compact fields
    ...
    // Service type required for general variant only
    if (variant === 'general' && !hideServiceSelector && !formData.serviceType) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Add form location if provided
      if (formLocation) {
        submitData.set('formLocation', formLocation)
      }
  ...
  // Get form title based on variant
  const getFormTitle = () => {
    if (title) return title
    switch (variant) {
      case 'cognitive-debriefing':
        return 'Request Cognitive Debriefing Quote'
      case 'clinician-review':
        return 'Request Clinician Review Quote'
      default:
        return 'Request a Quote'
    }
  }

  // Check if expanded section has any content
        ...
        <Card padding="none" className="overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-6" aria-label="Life sciences quote request form">
            ...
            <div className="space-y-4">
              ...
              {/* Service Type - only for general variant */}
              {!hideServiceSelector && variant === 'general' && (
                <Select
                  label="Service Type"
              ...
              <Textarea
                ...
                placeholder={
                  variant === 'cognitive-debriefing'
                    ? "Briefly describe your study, the instrument being validated, and any special requirements..."
                    : variant === 'clinician-review'
                    ? "Describe the documents requiring clinical review and any specific concerns..."
                    : "Describe your project, including any specific requirements or deadlines..."
                }
              ...
              <button
                ...
                className={`w-full flex items-center justify-between px-4 py-3 rounded-lg border-2 transition-all ${
                  isExpanded
                    ...
                    : 'border-slate-200 hover:border-teal-300 text-slate-600 hover:text-teal-600'
                }`}
              >
                <span className="font-medium">
                  Need to specify languages, timelines, or upload files?
                </span>
                <ChevronDown
                ...
                {isExpanded && (
                  ...
                  >
                    <div className="pt-6 space-y-6">
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          ...
                          <Select
                            ...
                            options={
                              variant === 'clinician-review'
                                ? CLINICIAN_THERAPEUTIC_AREAS
                                : therapeuticAreas.map((t) => ({ value: t.value, label: t.label }))
                            }
                      ...
                      {variant === 'cognitive-debriefing' && (
                        <div>
                          <h3 className="text-sm font-semibold text-slate-700 mb-3">Study Details</h3>
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <Select
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                            ...
                            <div>
                              ...
                              />
                              <p className="text-xs text-slate-500 mt-1">ISPOR recommends 5-8 per language</p>
                            </div>
                          </div>
                        </div>
                      )}
                      ...
                      {variant === 'clinician-review' && (
                        <div>
                          <h3 className="text-sm font-semibold text-slate-700 mb-3">Review Requirements</h3>
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <Select
                              label="Document Type"
                      ...
                      {(variant === 'general' || variant === 'linguistic-validation') && (
                        <div>
                          <h3 className="text-sm font-semibold text-slate-700 mb-3">Service Details</h3>
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <Select
                              label="Study Phase"
                      ...
                      <div>
                        ...
                        <div className="space-y-4">
                          <Select
                            ...
                            helperText={localesLoading ? 'Loading languages...' : 'Optional'}
                          />
                          ...
                          <div>
                            ...
                            {localesLoading ? (
                              ...
                              <>
                                ...
                                <p className="mt-1 text-xs text-slate-500">Optional - Click to select multiple languages</p>
                              </>
                            )}
                          </div>
                        </div>
      ...
      {!isSubmitted && (
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-6 text-slate-400 text-sm">
            <span>GCP-Trained Linguists</span>
