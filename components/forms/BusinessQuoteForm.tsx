...
const DOCUMENT_TYPES = [
  ...
  { value: 'reports', label: 'Annual/Financial Reports' },
  { value: 'presentations', label: 'Presentations & Pitch Decks' },
  { value: 'marketing', label: 'Marketing Materials' },
  { value: 'correspondence', label: 'Business Correspondence' },
  { value: 'manuals', label: 'Employee Manuals & Policies' },
...
export default function BusinessQuoteForm() {
  ...
  const isStepValid = (step: number): boolean => {
    switch (step) {
      case 1:
        return !!(formData.documentType && formData.industry)
      case 2:
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
      <h3 className="text-2xl font-bold text-[#0C2340] mb-2 text-center">Business Translation Quote</h3>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0891B2] focus:border-transparent"
              />
              <p className="text-xs text-gray-500 mt-1">Helps us provide an accurate quote</p>
            </div>
          </div>
        )}
          ...
          <div className="space-y-4">
            ...
            <div className="bg-[#0C2340]/5 p-4 rounded-lg">
              ...
              <div className="grid grid-cols-2 gap-1 text-sm">
                ...
                <span className="font-medium">{INDUSTRIES.find(i => i.value === formData.industry)?.label || '-'}</span>
                ...
                <span className="font-medium">{formData.wordCount || 'TBD'}</span>
