...
const DOCUMENT_TYPES = [
  ...
  { value: 'litigation', label: 'Litigation Documents' },
  { value: 'patents', label: 'Patents & IP Documents' },
  { value: 'corporate', label: 'Corporate Documents' },
  { value: 'court', label: 'Court Filings & Pleadings' },
  { value: 'depositions', label: 'Depositions & Transcripts' },
  { value: 'regulatory', label: 'Regulatory Filings' },
...
export default function LegalQuoteForm() {
  ...
  const isStepValid = (step: number): boolean => {
    switch (step) {
      case 1:
        return !!(formData.documentType && formData.practiceArea)
      case 2:
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/general-quote', {
        ...
        body: JSON.stringify({
          ...
          additional_info: {
            ...
            word_count: formData.wordCount ? parseInt(formData.wordCount) : 0,
            certified_translation: formData.certified,
      ...
      trackGenerateLead('quote', 'Legal Translation Quote Submitted')
      setFormData({
        documentType: '',
        practiceArea: '',
        sourceLanguage: '',
  ...
  const stepLabels = ['Document Type', 'Languages', 'Contact Info', 'Review & Submit']
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
      <h3 className="text-2xl font-bold text-[#0C2340] mb-2 text-center">Legal Translation Quote</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <label className="flex items-start gap-3 cursor-pointer">
                ...
                />
                <div>
                  <span className="font-medium text-gray-900">Certified Translation Required</span>
                  <p className="text-sm text-gray-500 mt-1">
                    For court submissions, official filings, and regulatory submissions
                  </p>
                </div>
              </label>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-blue-50 rounded-lg">
              <p className="text-sm text-gray-700">
                <strong>Note:</strong> All our legal translators are certified and experienced in legal terminology.
                We maintain strict confidentiality protocols for all legal documents.
              </p>
            </div>
          </div>
        )}
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                placeholder="Case details, specific terminology requirements, formatting needs..."
            ...
            <div className="bg-[#0C2340]/5 p-4 rounded-lg">
              ...
              <div className="grid grid-cols-2 gap-1 text-sm">
                ...
                <span className="font-medium">{DOCUMENT_TYPES.find(d => d.value === formData.documentType)?.label || '-'}</span>

                <span className="text-gray-600">Practice Area:</span>
                <span className="font-medium">{PRACTICE_AREAS.find(p => p.value === formData.practiceArea)?.label || '-'}</span>
                ...
                <span className="font-medium">{formData.certified ? 'Yes' : 'No'}</span>
