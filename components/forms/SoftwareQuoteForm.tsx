...
const PROJECT_TYPES = [
  ...
  { value: 'game', label: 'Game Localization' },
  { value: 'ui-strings', label: 'UI Strings Only' },
...
const FILE_FORMATS = [
  ...
  { value: 'po', label: 'PO/POT' },
  { value: 'strings', label: '.strings (iOS)' },
  { value: 'resx', label: 'RESX (.NET)' },
...
export default function SoftwareQuoteForm() {
  ...
  const isStepValid = (step: number): boolean => {
    switch (step) {
      case 1:
        return !!(formData.projectType && formData.fileFormat)
      case 2:
      ...
      const response = await fetch('/api/general-quote', {
        ...
        body: JSON.stringify({
          ...
          additional_info: {
            ...
            string_count: formData.stringCount ? parseInt(formData.stringCount) : 0,
  ...
  const stepLabels = ['Project Type', 'Languages', 'Contact Info', 'Review & Submit']
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
      <h3 className="text-2xl font-bold text-[#0C2340] mb-2 text-center">Software Localization Quote</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => updateFormData('stringCount', e.target.value)}
                  placeholder="e.g., 500"
                  min="1"
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0891B2] focus:border-transparent"
                />
            ...
            <div className="p-4 bg-blue-50 rounded-lg">
              <p className="text-sm text-gray-700">
                <strong>Tip:</strong> You can export your strings to get an accurate count.
                We also offer free file analysis.
              </p>
            </div>
          </div>
        )}
        ...
        {currentStep === 2 && (
          <div className="space-y-4">
            ...
            <div className="p-4 bg-green-50 rounded-lg">
              <p className="text-sm text-gray-700">
                <strong>Volume Discount:</strong> Projects with 5+ languages receive special pricing.
                We support 200+ languages and locales.
              </p>
            </div>
          </div>
        )}
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                placeholder="Integration requirements, style guides, screenshots, context files..."
            ...
            <div className="bg-[#0C2340]/5 p-4 rounded-lg">
              ...
              <div className="grid grid-cols-2 gap-1 text-sm">
                ...
                <span className="font-medium">{PROJECT_TYPES.find(p => p.value === formData.projectType)?.label || '-'}</span>

                <span className="text-gray-600">File Format:</span>
                <span className="font-medium">{FILE_FORMATS.find(f => f.value === formData.fileFormat)?.label || '-'}</span>
                ...
                <span className="text-gray-600">Strings/Words:</span>
                <span className="font-medium">{formData.stringCount || '-'} / {formData.wordCount || '-'}</span>
