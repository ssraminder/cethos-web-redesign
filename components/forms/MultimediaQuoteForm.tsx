...
const CONTENT_TYPES = [
  ...
  { value: 'elearning', label: 'E-Learning / Training' },
...
export default function MultimediaQuoteForm() {
  ...
  const isStepValid = (step: number): boolean => {
    switch (step) {
      case 1:
        return !!(formData.serviceType && formData.contentType)
      case 2:
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/general-quote', {
        ...
        body: JSON.stringify({
          service_type: 'multimedia-translation',
          ...
          additional_info: {
            multimedia_service_type: formData.serviceType,
            content_type: formData.contentType,
            video_duration_minutes: formData.videoDuration ? parseInt(formData.videoDuration) : 0,
            number_of_videos: formData.numberOfVideos ? parseInt(formData.numberOfVideos) : 1,
  ...
  const stepLabels = ['Service Type', 'Languages', 'Contact Info', 'Review & Submit']
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
      <h3 className="text-2xl font-bold text-[#0C2340] mb-2 text-center">Multimedia Translation Quote</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => updateFormData('numberOfVideos', e.target.value)}
                  placeholder="e.g., 5"
                  min="1"
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0891B2] focus:border-transparent"
                />
            ...
            <div className="p-4 bg-blue-50 rounded-lg">
              <p className="text-sm text-gray-700">
                <strong>Note:</strong> Pricing is typically based on video duration.
                For dubbing/voiceover, we offer both AI and human voice options.
              </p>
            </div>
          </div>
        )}
        ...
        {currentStep === 2 && (
          <div className="space-y-4">
            ...
            <div className="p-4 bg-green-50 rounded-lg">
              <p className="text-sm text-gray-700">
                <strong>Multi-language discount:</strong> Projects with 5+ languages
                receive special pricing. We support 200+ languages.
              </p>
            </div>
          </div>
        )}
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                placeholder="File format preferences, voice type for dubbing, timing constraints..."
            ...
            <div className="bg-[#0C2340]/5 p-4 rounded-lg">
              ...
              <div className="grid grid-cols-2 gap-1 text-sm">
                ...
                <span className="font-medium">{CONTENT_TYPES.find(c => c.value === formData.contentType)?.label || '-'}</span>
                ...
                <span className="text-gray-600">Duration/Videos:</span>
                <span className="font-medium">{formData.videoDuration || '-'} min / {formData.numberOfVideos || '1'} video(s)</span>
