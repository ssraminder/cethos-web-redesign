...
function WorldMapIllustration() {
  return (
    ...
    >
      <img
        src="https://lmzoyezvsjgsxveoakdr.supabase.co/storage/v1/object/public/web-assets/dotted-world-map.png"
        alt="Global translation services coverage"
