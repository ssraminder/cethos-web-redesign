...
export default function AboutPageContent() {
  ...
  const tOffices = useTranslations('about.offices')
  const tStats = useTranslations('about.stats')
  const tDiff = useTranslations('about.differentiators')
  const tCta = useTranslations('about.cta')
  const tFaq = useTranslations('about.faq')
  const tServices = useTranslations('about.services')
  const tIndustries = useTranslations('about.industries')
  const tQuality = useTranslations('about.quality')
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="min-h-[400px] bg-gradient-to-br from-[#0C2340] via-[#0C2340] to-[#0891B2] pt-32 pb-16 flex items-center">
        <div className="container mx-auto px-4 text-center">
          ...
          <nav className="text-sm text-gray-300 mb-6">
            ...
            <span className="text-white">{tHero('breadcrumb_about')}</span>
          </nav>
            ...
            <div className="lg:col-span-3">
              ...
              <div className="flex flex-wrap gap-6 mt-8 pt-8 border-t border-gray-200">
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  ...
                  <span>{tStory('badge_canadian')}</span>
                </div>
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  <div className="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center">
                    <svg className="w-6 h-6 text-[#0891B2]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="relative">
                ...
                <div className="relative rounded-2xl shadow-xl overflow-hidden aspect-[4/5] bg-gradient-to-br from-[#0C2340] to-[#0891B2] flex items-center justify-center">
                  <div className="text-center p-8">
                    ...
                    <p className="text-white/50 text-sm">{tStory('badge_team')}</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-[#0C2340] mb-2">{tOffices('calgary_title')}</h3>
              <p className="text-sm text-[#0891B2] font-medium mb-3">{tOffices('calgary_label')}</p>
              <p className="text-gray-600 text-sm">
                {tOffices('calgary_desc')}
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-[#0C2340] mb-2">{tOffices('dubai_title')}</h3>
              <p className="text-sm text-[#0891B2] font-medium mb-3">{tOffices('dubai_label')}</p>
              <p className="text-gray-600 text-sm">
                {tOffices('dubai_desc')}
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-[#0C2340] mb-2">{tOffices('india_title')}</h3>
              <p className="text-sm text-[#0891B2] font-medium mb-3">{tOffices('india_label')}</p>
              <p className="text-gray-600 text-sm">
                {tOffices('india_desc')}
              </p>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <h4 className="font-semibold text-[#0C2340] mb-1">{tOffices('stat_countries')}</h4>
              <p className="text-sm text-gray-500">{tOffices('stat_countries_desc')}</p>
            </div>
            <div className="text-center">
              <div className="w-14 h-14 bg-[#0891B2]/10 rounded-full flex items-center justify-center mx-auto mb-3">
                <svg className="w-7 h-7 text-[#0891B2]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h4 className="font-semibold text-[#0C2340] mb-1">{tOffices('stat_operations')}</h4>
              <p className="text-sm text-gray-500">{tOffices('stat_operations_desc')}</p>
            </div>
            <div className="text-center">
              <div className="w-14 h-14 bg-[#0891B2]/10 rounded-full flex items-center justify-center mx-auto mb-3">
                <svg className="w-7 h-7 text-[#0891B2]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h4 className="font-semibold text-[#0C2340] mb-1">{tOffices('stat_speakers')}</h4>
              <p className="text-sm text-gray-500">{tOffices('stat_speakers_desc')}</p>
            </div>
            <div className="text-center">
              <div className="w-14 h-14 bg-[#0891B2]/10 rounded-full flex items-center justify-center mx-auto mb-3">
                <svg className="w-7 h-7 text-[#0891B2]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h4 className="font-semibold text-[#0C2340] mb-1">{tOffices('stat_jurisdictions')}</h4>
              <p className="text-sm text-gray-500">{tOffices('stat_jurisdictions_desc')}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0C2340] mb-4">
              {tOffices('detail_heading')}
            </h2>
            <p className="text-lg text-gray-600">
              {tOffices('detail_desc')}
            </p>
          </div>
            ...
            <div className="bg-gray-50 rounded-2xl overflow-hidden border border-gray-100">
              <div className="bg-[#0C2340] p-6">
                <div className="flex items-center gap-3">
                  ...
                  />
                  <div>
                    <h3 className="text-xl font-bold text-white">{tOffices('detail_calgary_region')}</h3>
                    <p className="text-[#0891B2] text-sm">{tOffices('detail_calgary_city')}</p>
                  </div>
                </div>
              </div>
              <div className="p-6">
                <span className="inline-block bg-[#0891B2]/10 text-[#0891B2] text-xs font-semibold px-3 py-1 rounded-full mb-4">
                  {tOffices('detail_calgary_badge')}
                </span>
                ...
                <div className="space-y-3 text-sm text-gray-600 mb-6">
                  <p className="flex items-start gap-2">
                    ...
                    <span dangerouslySetInnerHTML={{ __html: tOffices('detail_calgary_address') }} />
                  </p>
                  <p className="flex items-center gap-2">
                    <svg className="w-5 h-5 text-gray-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <span>{tOffices('detail_calgary_hours')}</span>
                  </p>
                  <p className="flex items-center gap-2">
                    <svg className="w-5 h-5 text-gray-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                    <span>{tOffices('detail_calgary_phone')}</span>
                  </p>
                </div>

                <div className="pt-4 border-t border-gray-200">
                  <p className="text-xs text-gray-500 font-medium mb-2">{tOffices('detail_services_label')}</p>
                  <div className="flex flex-wrap gap-1">
                    <span className="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded">{tOffices('detail_calgary_svc1')}</span>
                    <span className="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded">{tOffices('detail_calgary_svc2')}</span>
                    <span className="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded">{tOffices('detail_calgary_svc3')}</span>
                    <span className="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded">{tOffices('detail_calgary_svc4')}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-2xl overflow-hidden border border-gray-100">
              <div className="bg-[#0C2340] p-6">
                <div className="flex items-center gap-3">
                  ...
                  />
                  <div>
                    <h3 className="text-xl font-bold text-white">{tOffices('detail_dubai_region')}</h3>
                    <p className="text-[#0891B2] text-sm">{tOffices('detail_dubai_city')}</p>
                  </div>
                </div>
              </div>
              <div className="p-6">
                <span className="inline-block bg-[#0891B2]/10 text-[#0891B2] text-xs font-semibold px-3 py-1 rounded-full mb-4">
                  {tOffices('detail_dubai_badge')}
                </span>
                ...
                <div className="space-y-3 text-sm text-gray-600 mb-6">
                  <p className="flex items-start gap-2">
                    ...
                    <span dangerouslySetInnerHTML={{ __html: tOffices('detail_dubai_address') }} />
                  </p>
                  <p className="flex items-center gap-2">
                    <svg className="w-5 h-5 text-gray-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <span>{tOffices('detail_dubai_hours')}</span>
                  </p>
                </div>
                ...
                <div className="pt-4 border-t border-gray-200">
                  <p className="text-xs text-gray-500 font-medium mb-2">{tOffices('detail_services_label')}</p>
                  <div className="flex flex-wrap gap-1">
                    <span className="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded">{tOffices('detail_dubai_svc1')}</span>
                    <span className="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded">{tOffices('detail_dubai_svc2')}</span>
                    <span className="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded">{tOffices('detail_dubai_svc3')}</span>
                    <span className="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded">{tOffices('detail_dubai_svc4')}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-2xl overflow-hidden border border-gray-100">
              <div className="bg-[#0C2340] p-6">
                <div className="flex items-center gap-3">
                  ...
                  />
                  <div>
                    <h3 className="text-xl font-bold text-white">{tOffices('detail_india_region')}</h3>
                    <p className="text-[#0891B2] text-sm">{tOffices('detail_india_city')}</p>
                  </div>
                </div>
              </div>
              <div className="p-6">
                <span className="inline-block bg-[#0891B2]/10 text-[#0891B2] text-xs font-semibold px-3 py-1 rounded-full mb-4">
                  {tOffices('detail_india_badge')}
                </span>
                ...
                <div className="space-y-3 text-sm text-gray-600 mb-6">
                  <p className="flex items-start gap-2">
                    ...
                    <span dangerouslySetInnerHTML={{ __html: tOffices('detail_india_address') }} />
                  </p>
                  <p className="flex items-center gap-2">
                    <svg className="w-5 h-5 text-gray-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <span>{tOffices('detail_india_hours')}</span>
                  </p>
                </div>
                ...
                <div className="pt-4 border-t border-gray-200">
                  <p className="text-xs text-gray-500 font-medium mb-2">{tOffices('detail_services_label')}</p>
                  <div className="flex flex-wrap gap-1">
                    <span className="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded">{tOffices('detail_india_svc1')}</span>
                    <span className="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded">{tOffices('detail_india_svc2')}</span>
                    <span className="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded">{tOffices('detail_india_svc3')}</span>
                    <span className="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded">{tOffices('detail_india_svc4')}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mt-12 bg-[#0C2340] rounded-2xl p-8 text-center">
            <p className="text-[#0891B2] font-medium mb-2">{tOffices('follow_sun_label')}</p>
            <p className="text-white text-lg">
              {tOffices('follow_sun_quote')}
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {[
              { valueKey: 'languages', labelKey: 'languages_label' },
              { valueKey: 'countries', labelKey: 'countries_label' },
              { valueKey: 'linguists', labelKey: 'linguists_label' },
              { valueKey: 'moderators', labelKey: 'moderators_label' },
              { valueKey: 'areas', labelKey: 'areas_label' },
              { valueKey: 'rating', labelKey: 'rating_label' },
            ].map((stat) => (
              <div key={stat.valueKey} className="bg-white rounded-xl p-6 text-center shadow-sm border border-gray-100">
                <div className="text-4xl font-bold text-[#0891B2] mb-2">{tStats(stat.valueKey)}</div>
                <div className="text-sm text-gray-600">{tStats(stat.labelKey)}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-[#0C2340] to-[#0F3A5C] rounded-2xl p-8 text-white">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">{tServices('lifesci_title')}</h3>
              <p className="text-gray-300 mb-6">
                {tServices('lifesci_desc')}
              </p>

              <ul className="space-y-2 mb-8">
                {[
                  tServices('lifesci_item1'),
                  tServices('lifesci_item2'),
                  tServices('lifesci_item3'),
                  tServices('lifesci_item4'),
                  tServices('lifesci_item5'),
                  tServices('lifesci_item6'),
                  tServices('lifesci_item7'),
                  tServices('lifesci_item8'),
                ].map((item) => (
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200">
              ...
              <h3 className="text-2xl font-bold text-[#0C2340] mb-4">{tServices('certified_title')}</h3>
              <p className="text-gray-600 mb-6">
                {tServices('certified_desc')}
              </p>

              <ul className="space-y-2 mb-8">
                {[
                  tServices('certified_item1'),
                  tServices('certified_item2'),
                  tServices('certified_item3'),
                  tServices('certified_item4'),
                  tServices('certified_item5'),
                  tServices('certified_item6'),
                ].map((item) => (
              ...
              <div className="flex flex-wrap gap-3 mb-6">
                <span className="inline-flex items-center gap-1 text-xs bg-green-100 text-green-700 px-3 py-1 rounded-full">
                  ...
                  {tServices('certified_badge1')}
                </span>
                <span className="inline-flex items-center gap-1 text-xs bg-green-100 text-green-700 px-3 py-1 rounded-full">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  {tServices('certified_badge2')}
                </span>
              </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { titleKey: 'human_title', descKey: 'human_desc', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
              { titleKey: 'expertise_title', descKey: 'expertise_desc', icon: 'M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z' },
              { titleKey: 'quality_title', descKey: 'quality_desc', icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z' },
              { titleKey: 'fast_title', descKey: 'fast_desc', icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
              { titleKey: 'transparent_title', descKey: 'transparent_desc', icon: 'M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z' },
              { titleKey: 'secure_title', descKey: 'secure_desc', icon: 'M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z' },
            ].map((item) => (
              <div key={item.titleKey} className="text-center">
                ...
                <h3 className="text-xl font-bold text-[#0C2340] mb-3">{tDiff(item.titleKey)}</h3>
                <p className="text-gray-600">{tDiff(item.descKey)}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            {[
              { name: 'GDPR', description: tQuality('gdpr_desc') },
              { name: 'PIPEDA', description: tQuality('pipeda_desc') },
              { name: 'HIPAA', description: tQuality('hipaa_desc') }
            ].map((privacy) => (
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 pt-12 border-t border-gray-200">
            <div className="text-center">
              ...
              <div className="text-sm text-gray-500">{tQuality('bbb_label')}</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-[#0C2340]">AILIA</div>
              <div className="text-sm text-gray-500">{tQuality('ailia_label')}</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-[#0C2340]">{tQuality('gov_alberta_name')}</div>
              <div className="text-sm text-gray-500">{tQuality('gov_alberta_label')}</div>
            </div>
          </div>
        </div>
      </section>
