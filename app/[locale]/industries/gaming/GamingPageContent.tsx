...
export default function GamingPageContent() {
  const tHero = useTranslations('industry.gaming.hero')
  const tStats = useTranslations('industry.gaming.stats')
  const tChallenges = useTranslations('industry.gaming.challenges')
  const tServices = useTranslations('industry.gaming.services')
  const tFaq = useTranslations('industry.gaming.faq')
  const tCta = useTranslations('industry.gaming.cta')
