...
export default function TechnologyPageContent() {
  const tHero = useTranslations('industry.technology.hero')
  const tStats = useTranslations('industry.technology.stats')
  const tChallenges = useTranslations('industry.technology.challenges')
  const tServices = useTranslations('industry.technology.services')
  const tFaq = useTranslations('industry.technology.faq')
  const tCta = useTranslations('industry.technology.cta')
