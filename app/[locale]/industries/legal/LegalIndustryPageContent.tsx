...
export default function LegalIndustryPageContent() {
  const tHero = useTranslations('industry.legal.hero')
  const tStats = useTranslations('industry.legal.stats')
  const tChallenges = useTranslations('industry.legal.challenges')
  const tServices = useTranslations('industry.legal.services')
  const tFaq = useTranslations('industry.legal.faq')
  const tCta = useTranslations('industry.legal.cta')
