...
export default function PharmaceuticalPageContent() {
  const heroT = useTranslations('industry.pharmaceutical.hero')
  const statsT = useTranslations('industry.pharmaceutical.stats')
  const challengesT = useTranslations('industry.pharmaceutical.challenges')
  const servicesT = useTranslations('industry.pharmaceutical.services')
  const faqT = useTranslations('industry.pharmaceutical.faq')
  const ctaT = useTranslations('industry.pharmaceutical.cta')
