...
export default function FinancePageContent() {
  const tHero = useTranslations('industry.finance.hero')
  const tStats = useTranslations('industry.finance.stats')
  const tChallenges = useTranslations('industry.finance.challenges')
  const tServices = useTranslations('industry.finance.services')
  const tFaq = useTranslations('industry.finance.faq')
  const tCta = useTranslations('industry.finance.cta')

  const challenges = [
    {
      title: tChallenges('ch1_title'),
      description: tChallenges('ch1_desc'),
    },
    {
      title: tChallenges('ch2_title'),
      description: tChallenges('ch2_desc'),
    },
    {
      title: tChallenges('ch3_title'),
      description: tChallenges('ch3_desc'),
    },
    {
      title: tChallenges('ch4_title'),
      description: tChallenges('ch4_desc'),
    },
  ]
