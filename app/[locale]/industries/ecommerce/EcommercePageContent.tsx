...
export default function EcommercePageContent() {
  const tHero = useTranslations('industry.ecommerce.hero')
  const tStats = useTranslations('industry.ecommerce.stats')
  const tChallenges = useTranslations('industry.ecommerce.challenges')
  const tServices = useTranslations('industry.ecommerce.services')
  const tFaq = useTranslations('industry.ecommerce.faq')
  const tCta = useTranslations('industry.ecommerce.cta')
