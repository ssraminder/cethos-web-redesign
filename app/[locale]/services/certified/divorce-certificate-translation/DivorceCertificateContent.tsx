...
export default function DivorceCertificateContent() {
  const t = useTranslations('certified.divorce')
        ...
        <div className="max-w-[1200px] mx-auto px-8 py-16 md:py-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              >
                <TrustBar items={[t('trustbar_1'), t('trustbar_2'), t('trustbar_3'), t('trustbar_4')]} />
              </motion.div>
            </div>
      ...
      <section className="py-16 bg-[#0891B2]">
        <Container>
          <div className="text-center">
            ...
            <p className="text-white/90 mb-8 max-w-xl mx-auto">{t('cta_desc')}</p>
