...
export const metadata: Metadata = {
  title: 'Divorce Certificate Translation Canada | IRCC Certified | Same-Day | Cethos',
  description: 'Certified divorce certificate translation for IRCC. Divorce decrees, separation agreements, annulments. Same-day service available. 100% acceptance guarantee. Call (587) 600-0786.',
  alternates: {
    canonical: 'https://cethos.com/services/certified/divorce-certificate-translation',
  },
  openGraph: {
    title: 'Divorce Certificate Translation Canada | IRCC Certified | Cethos',
