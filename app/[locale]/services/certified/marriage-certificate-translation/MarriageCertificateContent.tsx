...
import { ArrowRight, Phone, CheckCircle, Heart, FileText, Users, Shield, Clock, Award, Star, BadgeCheck } from 'lucide-react'
...
export default function MarriageCertificateContent() {
  const t = useTranslations('certified.marriage')
  ...
  const documentTypes = [
    {
      ...
      items: [t('doctype1_item1'), t('doctype1_item2'), t('doctype1_item3'), t('doctype1_item4')],
    },
    {
      title: t('doctype2_title'),
      items: [t('doctype2_item1'), t('doctype2_item2'), t('doctype2_item3'), t('doctype2_item4')],
    },
    {
      title: t('doctype3_title'),
      items: [t('doctype3_item1'), t('doctype3_item2'), t('doctype3_item3'), t('doctype3_item4')],
    },
  ]
