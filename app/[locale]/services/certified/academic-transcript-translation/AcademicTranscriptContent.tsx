...
export default function AcademicTranscriptContent() {
  const t = useTranslations('certified.academic')
  ...
  const documentTypes = [
    {
      title: t('doctype1_title'),
      items: [t('doctype1_item1'), t('doctype1_item2'), t('doctype1_item3'), t('doctype1_item4'), t('doctype1_item5')],
    },
    {
      title: t('doctype2_title'),
      items: [t('doctype2_item1'), t('doctype2_item2'), t('doctype2_item3'), t('doctype2_item4'), t('doctype2_item5')],
    },
    {
      title: t('doctype3_title'),
      items: [t('doctype3_item1'), t('doctype3_item2'), t('doctype3_item3'), t('doctype3_item4'), t('doctype3_item5')],
    },
  ]

  const credentialAgencies = [
    { name: 'WES', full: t('agency_wes_full'), description: t('agency_wes_desc') },
    { name: 'IQAS', full: t('agency_iqas_full'), description: t('agency_iqas_desc') },
    { name: 'ICES', full: t('agency_ices_full'), description: t('agency_ices_desc') },
    { name: 'CES', full: t('agency_ces_full'), description: t('agency_ces_desc') },
    { name: 'MCC', full: t('agency_mcc_full'), description: t('agency_mcc_desc') },
    { name: 'PEBC', full: t('agency_pebc_full'), description: t('agency_pebc_desc') },
  ]
  ...
  return (
    <>
      ...
      <section className="py-16 bg-slate-50">
        <Container>
          <h2 className="text-3xl font-bold text-[#0C2340] text-center mb-12">{t('docs_heading')}</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
      ...
      <section className="py-16 bg-white">
        <Container>
          <h2 className="text-3xl font-bold text-[#0C2340] text-center mb-4">{t('agencies_heading')}</h2>
          <p className="text-center text-slate-600 mb-12 max-w-2xl mx-auto">{t('agencies_desc')}</p>
