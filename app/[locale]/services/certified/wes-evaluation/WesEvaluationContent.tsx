...
export default function WesEvaluationContent() {
  const t = useTranslations('certified.wes')
  ...
  const pricingTable = [
    ...
    { service: t('pricing.row5_service'), price: t('pricing.row5_price') },
  ]
  ...
  return (
    <>
      ...
      <section className="py-16 bg-white">
        <Container>
          <h2 className="text-3xl font-bold text-[#0C2340] text-center mb-4">{t('languages.title')}</h2>
          <p className="text-center text-slate-600 mb-8">{t('languages.subtitle')}</p>
          ...
          <p className="text-center text-sm text-slate-500 mt-4">{t('languages.contact')}</p>
        </Container>
      </section>
      ...
      <section className="py-16 bg-slate-50">
        <Container>
          <h2 className="text-3xl font-bold text-[#0C2340] text-center mb-4">{t('locations.title')}</h2>
          <p className="text-slate-600 text-center mb-8">{t('locations.subtitle')}</p>
          <div className="flex flex-wrap justify-center gap-4">
            {[
