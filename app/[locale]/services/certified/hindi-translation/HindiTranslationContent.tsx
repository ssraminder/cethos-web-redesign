...
export default function HindiTranslationContent() {
  const t = useTranslations('certified.hindi')

  const breadcrumbItems = [
    { name: 'Services', url: '/services' },
    { name: 'Certified Translation', url: '/services/certified' },
    { name: 'Hindi Translation', url: '/services/certified/hindi-translation' },
  ]
      ...
      <section className="pt-20 bg-gradient-to-br from-white via-[#F8FAFC] to-[#E0F2FE]">
        <div className="max-w-[1200px] mx-auto px-8 py-16 md:py-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            >
              <EmbeddedCertifiedQuoteForm formLocation="hindi-translation" />
            </motion.div>
          </div>
        </div>
      </section>
