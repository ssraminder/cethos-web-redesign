...
export default function ExpressEntryContent() {
  const t = useTranslations('certified.express-entry')
  ...
  const documentChecklist = [
    t('checklist_1'), t('checklist_2'), t('checklist_3'), t('checklist_4'),
    t('checklist_5'), t('checklist_6'), t('checklist_7'), t('checklist_8'),
  ]
        ...
        <div className="max-w-[1200px] mx-auto px-8 py-16 md:py-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <motion.div id="quote-form" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5, delay: 0.2 }} className="bg-white rounded-2xl shadow-lg p-6 md:p-8">
              <EmbeddedCertifiedQuoteForm defaultDocumentType="immigration" formLocation="express-entry" />
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <Container>
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-[#0C2340] mb-4">{t('checklist_heading')}</h2>
            <p className="text-slate-600">{t('checklist_desc')}</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <Card className="p-6 text-center">
              <Plane className="w-10 h-10 text-teal-600 mx-auto mb-4" />
              <h3 className="font-semibold text-[#0C2340] mb-2">{t('checklist_card1_title')}</h3>
              <p className="text-sm text-slate-600">{t('checklist_card1_desc')}</p>
            </Card>
            <Card className="p-6 text-center">
              <FileText className="w-10 h-10 text-teal-600 mx-auto mb-4" />
              <h3 className="font-semibold text-[#0C2340] mb-2">{t('checklist_card2_title')}</h3>
              <p className="text-sm text-slate-600">{t('checklist_card2_desc')}</p>
            </Card>
            <Card className="p-6 text-center">
              <Shield className="w-10 h-10 text-teal-600 mx-auto mb-4" />
              <h3 className="font-semibold text-[#0C2340] mb-2">{t('checklist_card3_title')}</h3>
              <p className="text-sm text-slate-600">{t('checklist_card3_desc')}</p>
            </Card>
          </div>
      ...
      <section className="py-12 bg-white border-t">
        <Container>
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/services/certified/wes-evaluation" className="text-[#0891B2] hover:underline">{t('related_wes')}</Link>
