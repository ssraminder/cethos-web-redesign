...
const INSTRUMENT_ICONS = [ICON_CLIPBOARD_CHECK, ICON_DOC, ICON_BEAKER, "M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m6-1.13a4 4 0 10-4-4 4 4 0 004 4z"]

export default function LinguisticValidationContent() {
  const t = useTranslations('lifesciences.linguistic-validation')

  const stats = [
    { stat: t('stats.linguists'), label: t('stats.linguists_label') },
    { stat: t('stats.languages'), label: t('stats.languages_label') },
    { stat: t('stats.therapeutic'), label: t('stats.therapeutic_label') },
    { stat: t('stats.instruments'), label: t('stats.instruments_label') },
  ]

  const isporSteps = [
    { step: '1', title: t('ispor.step1_title'), desc: t('ispor.step1_desc') },
    { step: '2', title: t('ispor.step2_title'), desc: t('ispor.step2_desc') },
    { step: '3', title: t('ispor.step3_title'), desc: t('ispor.step3_desc') },
    { step: '4', title: t('ispor.step4_title'), desc: t('ispor.step4_desc') },
    { step: '5', title: t('ispor.step5_title'), desc: t('ispor.step5_desc') },
    { step: '6', title: t('ispor.step6_title'), desc: t('ispor.step6_desc') },
    { step: '7', title: t('ispor.step7_title'), desc: t('ispor.step7_desc') },
    { step: '8', title: t('ispor.step8_title'), desc: t('ispor.step8_desc') },
    { step: '9', title: t('ispor.step9_title'), desc: t('ispor.step9_desc') },
  ]

  const instruments = [
    { code: 'PRO', name: t('instruments.pro_name'), desc: t('instruments.pro_desc'), icon: INSTRUMENT_ICONS[0] },
    { code: 'ClinRO', name: t('instruments.clinro_name'), desc: t('instruments.clinro_desc'), icon: INSTRUMENT_ICONS[1] },
    { code: 'ObsRO', name: t('instruments.obsro_name'), desc: t('instruments.obsro_desc'), icon: INSTRUMENT_ICONS[3] },
  ...
  const deliverables = [
    ...
    { icon: ICON_CLIPBOARD_CHECK, title: t('deliverables.item2_title'), desc: t('deliverables.item2_desc') },
    { icon: ICON_BEAKER, title: t('deliverables.item3_title'), desc: t('deliverables.item3_desc') },
  ...
  const therapeuticAreas = [
    ...
    t('therapeutic.area13'), t('therapeutic.area14'), t('therapeutic.area15'), t('therapeutic.area16'),
    t('therapeutic.area17'), t('therapeutic.area18'), t('therapeutic.area19'), t('therapeutic.area20'),
  ]
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl">
            ...
            <div className="flex flex-wrap gap-6 mt-12 text-sm text-gray-400">
              <span className="flex items-center gap-2"><HeroBadgeIcon />{t('hero.badge_linguists')}</span>
      ...
      <section className="py-16 md:py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl">
            ...
            <p className="mt-4 text-lg text-gray-600 leading-relaxed">
              {t.rich('what.p3', { strong: (chunks) => <strong>{chunks}</strong> })}
            </p>
          </div>
      ...
      <section id="process" className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0C2340]">{t('ispor.title')}</h2>
            <p className="mt-4 text-lg text-gray-600">{t('ispor.subtitle')}</p>
          </div>
      ...
      {/* Related Services */}
      <LifeSciencesRelated current="linguistic-validation" />
