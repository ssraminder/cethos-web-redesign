...
const serviceItems = [
  { icon: Subtitles, titleKey: 'subtitling_title', descKey: 'subtitling_desc' },
  { icon: Mic, titleKey: 'voiceover_title', descKey: 'voiceover_desc' },
  { icon: Video, titleKey: 'video_title', descKey: 'video_desc' },
  { icon: GraduationCap, titleKey: 'elearning_title', descKey: 'elearning_desc' },
  { icon: FileAudio, titleKey: 'audio_title', descKey: 'audio_desc' },
  { icon: CheckSquare, titleKey: 'qa_title', descKey: 'qa_desc' },
]

const whyItems = [
  { titleKey: 'talent_title', descKey: 'talent_desc' },
  { titleKey: 'broadcast_title', descKey: 'broadcast_desc' },
  { titleKey: 'production_title', descKey: 'production_desc' },
]

const trustSignals = [
  { icon: Languages, labelKey: 'trust_1' },
  { icon: Globe, labelKey: 'trust_2' },
  { icon: BadgeCheck, labelKey: 'trust_3' },
]

export default function MultimediaPageContent() {
        ...
        <div className="max-w-[1200px] mx-auto px-8 py-24">
          <Breadcrumbs
            items={[
              ...
              { name: 'Multimedia Translation', url: '/services/multimedia' },
            ]}
