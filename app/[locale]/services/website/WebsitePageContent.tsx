...
export default function WebsitePageContent() {
  ...
  const tServices = useTranslations('service.website.services')
  const tWhy = useTranslations('service.website.why')
  const tCta = useTranslations('service.website.cta')

  const services = [
    {
      icon: FileText,
      titleKey: 'content_title' as const,
      descKey: 'content_desc' as const,
    },
    {
      icon: Search,
      titleKey: 'seo_title' as const,
      descKey: 'seo_desc' as const,
    },
    {
      icon: Puzzle,
      titleKey: 'cms_title' as const,
      descKey: 'cms_desc' as const,
    },
    {
      icon: CheckSquare,
      titleKey: 'qa_title' as const,
      descKey: 'qa_desc' as const,
    },
    {
      icon: Palette,
      titleKey: 'cultural_title' as const,
      descKey: 'cultural_desc' as const,
    },
    {
      icon: RefreshCw,
      titleKey: 'updates_title' as const,
      descKey: 'updates_desc' as const,
    },
  ]

  const trustSignals = [
    { icon: Languages, labelKey: 'trust_1' as const },
    { icon: Globe, labelKey: 'trust_2' as const },
    { icon: BadgeCheck, labelKey: 'trust_3' as const },
  ]

  const whyItems = [
    { titleKey: 'seo_title' as const, descKey: 'seo_desc' as const },
    { titleKey: 'platform_title' as const, descKey: 'platform_desc' as const },
    { titleKey: 'scalable_title' as const, descKey: 'scalable_desc' as const },
  ]
