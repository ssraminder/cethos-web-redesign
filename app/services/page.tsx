...
export const metadata: Metadata = {
  ...
  keywords: ['translation services', 'localization services', 'life sciences translation', 'certified translation', 'website localization', 'software localization', 'interpretation services', 'transcription services'],
  alternates: {
