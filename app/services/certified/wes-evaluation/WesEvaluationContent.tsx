...
import { ArrowRight, Phone, CheckCircle, Shield, Clock, Award, FileText, Globe, Star, BadgeCheck, GraduationCap } from 'lucide-react'
...
const whatsIncluded = [
  'Certified translation accepted by WES',
  'Signed certificate of accuracy',
  'Commissioner certification (notarization equivalent)',
  'Format matching for WES submission requirements',
  'Digital copy via email for online submission',
  'Physical copy available for pickup or mail',
...
const pricingTable = [
  ...
  { service: 'WES Bundle (Transcript + Diploma)', price: 'Starting at $120' },
  { service: 'Commissioner Certification', price: 'Included' },
  { service: 'Same-Day Rush', price: '+$25' },
]

const howItWorks = [
  { step: 1, title: 'Upload Your Documents', description: 'Scan or photograph your academic transcripts, diplomas, or degree certificates and upload through our secure form.' },
  ...
  { step: 3, title: 'We Translate', description: 'Our certified translator completes your translation in the format WES requires.' },
  { step: 4, title: 'Submit to WES', description: 'Receive your certified translation via email or mail—ready for WES submission.' },
]

const faqs = [
  {
    question: 'Does WES accept your translations?',
    answer: 'Yes. Our certified translations are accepted by WES (World Education Services) for all credential evaluation purposes, including ECA for Express Entry. Each translation includes a signed certificate of accuracy and commissioner certification as required by WES.',
  },
  {
    question: 'What documents does WES require to be translated?',
    answer: 'WES typically requires certified translation of academic transcripts, degree certificates, diplomas, and mark sheets. If any of these documents are not in English or French, they must be translated by a certified translator. We translate all academic document types from any language.',
  },
  {
    question: 'How long does WES translation take?',
    answer: 'Standard turnaround is 2-3 business days. Same-day rush service is available for an additional $25 per document. We recommend starting your translation early, as the WES evaluation itself can take several weeks.',
  },
  {
    question: 'Can you send translations directly to WES?',
    answer: 'We provide you with certified copies that you can include with your WES application. WES requires that translations come from a certified translator, and our documents include all the certifications WES needs to accept the translation.',
  },
  {
    question: 'What is an ECA and why do I need one?',
    answer: 'An Educational Credential Assessment (ECA) verifies that your foreign education is equivalent to a Canadian credential. It is mandatory for Express Entry (Federal Skilled Worker program) and earns you CRS points. WES is one of the designated organizations that performs ECAs for IRCC.',
  },
]
...
const breadcrumbItems = [
  ...
  { name: 'WES Evaluation', url: '/services/certified/wes-evaluation' },
]

export default function WesEvaluationContent() {
  return (
    <>
        ...
        <div className="max-w-[1200px] mx-auto px-8 py-16 md:py-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div className="max-w-xl">
              ...
              >
                Certified translation of academic transcripts, diplomas, and degree certificates for WES credential evaluation. Required for Express Entry ECA applications.
              </motion.p>
              ...
              >
                Accepted by WES, IRCC, and all Canadian immigration authorities. Government of Alberta approved translator.
              </motion.p>
      ...
      {/* Why WES Requires Translation */}
      <section className="py-16 bg-white">
        <Container>
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-[#0C2340] mb-4">Why WES Requires Certified Translation</h2>
            <p className="text-slate-600">
              World Education Services (WES) requires certified English or French translations of all academic documents not originally issued in those languages. This is mandatory for Educational Credential Assessments (ECA) used in Express Entry applications.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <Card className="p-6 text-center">
              <GraduationCap className="w-10 h-10 text-teal-600 mx-auto mb-4" />
              <h3 className="font-semibold text-[#0C2340] mb-2">Credential Verification</h3>
              <p className="text-sm text-slate-600">WES evaluates your foreign education against Canadian standards to determine equivalency.</p>
            </Card>
            <Card className="p-6 text-center">
              <FileText className="w-10 h-10 text-teal-600 mx-auto mb-4" />
              <h3 className="font-semibold text-[#0C2340] mb-2">ECA for Express Entry</h3>
              <p className="text-sm text-slate-600">An ECA report from WES is mandatory for the Federal Skilled Worker program and earns CRS points.</p>
            </Card>
            <Card className="p-6 text-center">
              ...
              <p className="text-sm text-slate-600">Many Canadian professional bodies require WES evaluation for foreign-trained professionals.</p>
            </Card>
          </div>
        </Container>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-[#0C2340] to-[#164e63]">
        <Container>
          <div className="text-center">
            <h2 className="text-3xl font-bold text-white mb-4">Get Your WES Translation Started Today</h2>
            <p className="text-white/80 mb-8 max-w-2xl mx-auto">
              Certified academic translations from $65. Accepted by WES, IRCC, and all Canadian immigration authorities.
            </p>
