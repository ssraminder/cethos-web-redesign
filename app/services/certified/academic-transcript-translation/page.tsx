...
export const metadata: Metadata = {
  title: 'Academic Transcript Translation Canada | WES IQAS Certified | Cethos',
  description: 'Certified academic transcript translation for WES, IQAS, Express Entry. Diplomas, degrees, transcripts. Same-day service available. 100% acceptance guarantee.',
  alternates: {
