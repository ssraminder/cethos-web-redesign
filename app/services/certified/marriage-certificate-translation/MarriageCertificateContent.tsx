        ...
        <div className="max-w-[1200px] mx-auto px-8 py-16 md:py-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div className="max-w-xl">
              ...
              >
                Perfect for spousal sponsorship applications. Government of Alberta approved translator with commissioner certification included.
              </motion.p>
      ...
      <section className="py-16 bg-gradient-to-r from-[#0C2340] to-[#164e63]">
        <Container>
          <div className="text-center">
            <h2 className="text-3xl font-bold text-white mb-4">Get Your Marriage Certificate Translated Today</h2>
            <p className="text-white/80 mb-8 max-w-2xl mx-auto">
              Certified marriage certificate translations from $65. Perfect for spousal sponsorship applications.
            </p>
