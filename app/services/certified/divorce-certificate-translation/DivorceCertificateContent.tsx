...
import { Phone, CheckCircle, Shield, Clock, Award, FileText, Scale } from 'lucide-react'
...
const pricingTable = [
  { service: 'Divorce Certificate Translation', price: 'Starting at $65' },
...
const howItWorks = [
  { step: 1, title: 'Upload Your Document', description: 'Take a clear photo or scan of your divorce certificate and upload it through our secure form.' },
...
const faqs = [
  {
    question: 'What divorce documents do you translate for IRCC?',
    answer: 'We translate all types of divorce-related documents including divorce certificates, divorce decrees, final judgment of divorce, separation agreements, annulment decrees, and court orders. All translations are certified for IRCC acceptance.',
  },
  {
    question: 'Why does IRCC require divorce certificate translation?',
    answer: 'IRCC requires certified translation of divorce documents to verify your marital status for immigration applications. This is especially important for spousal sponsorship, where IRCC needs to confirm that any previous marriages have been legally dissolved.',
  },
  {
    question: 'How much does divorce certificate translation cost?',
    answer: 'Divorce certificate translation starts at $65, which includes the certified translation and commissioner certification. Longer divorce decrees with multiple pages may cost more. Same-day rush service is available for an additional $25.',
  },
  {
    question: 'What if my divorce decree has multiple pages?',
    answer: 'Multi-page divorce decrees are priced per page after the first page. Upload your complete document and we will provide an exact quote based on the total length and complexity.',
  },
  {
    question: 'Do I need to translate the entire divorce decree or just the certificate?',
    answer: 'For most IRCC applications, you need to translate the official certificate or the final pages showing the divorce is finalized. However, some applications may require the full decree. We can advise you based on your specific application type.',
  },
]
...
const breadcrumbItems = [
  ...
  { name: 'Divorce Certificate Translation', url: '/services/certified/divorce-certificate-translation' },
]

export default function DivorceCertificateContent() {
  return (
    <>
        ...
        <div className="max-w-[1200px] mx-auto px-8 py-16 md:py-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              >
                Divorce Certificate Translation Calgary
              </motion.h1>
              ...
              >
                IRCC-certified translations for divorce decrees, separation agreements, and annulments. Same-day service available with on-site notarization.
              </motion.p>
            ...
            >
              ...
              <p className="text-slate-600 mb-6">Upload your divorce certificate for a quick quote.</p>
              <EmbeddedCertifiedQuoteForm
                defaultDocumentType="divorce-certificate"
                formLocation="divorce-certificate-translation"
              />
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <Container>
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-[#0C2340] mb-4">Why IRCC Requires Divorce Certificate Translation</h2>
            <p className="text-slate-600">
              Immigration, Refugees and Citizenship Canada requires certified translation of all foreign-language divorce documents. This verifies your marital status for immigration applications and spousal sponsorship.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <Card className="p-6 text-center">
              <Shield className="w-10 h-10 text-teal-600 mx-auto mb-4" />
              <h3 className="font-semibold text-[#0C2340] mb-2">Marital Status Verification</h3>
              <p className="text-sm text-slate-600">Divorce documents verify previous marriages have been legally dissolved.</p>
            </Card>
            <Card className="p-6 text-center">
              <Scale className="w-10 h-10 text-teal-600 mx-auto mb-4" />
            ...
            <Card className="p-6 text-center">
              ...
              <p className="text-sm text-slate-600">Essential for proving eligibility to sponsor a new spouse.</p>
            </Card>
          </div>
        </Container>
      </section>
      ...
      <section className="py-16 bg-[#0891B2]">
        <Container>
          <div className="text-center">
            <h2 className="text-3xl font-bold text-white mb-4">Get Your Divorce Certificate Translated Today</h2>
