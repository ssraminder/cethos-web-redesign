...
import { ArrowRight, Phone, CheckCircle, MapPin, Mail, Truck, Clock, Globe, Shield } from 'lucide-react'
        ...
        <div className="max-w-[1200px] mx-auto px-8 py-16 md:py-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              >
                <TrustBar items={['Serving Edmonton & Area', 'Email or Courier Delivery', '100% IRCC Acceptance', 'Same-Day Available']} />
              </motion.div>
            </div>
            ...
            >
              ...
              <p className="text-slate-600 mb-6">Upload your documents for a quick quote—no travel required.</p>
              <CertifiedQuoteForm formLocation="edmonton-translation-agency" />
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#0891B2]">
        <Container>
          <div className="text-center">
            <h2 className="text-3xl font-bold text-white mb-4">Get Your Translation from Edmonton</h2>
            <p className="text-white/90 mb-8">No travel required. Upload online and receive by email or courier.</p>
