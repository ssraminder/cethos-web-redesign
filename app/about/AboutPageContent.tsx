...
const values = [
  ...
  },
  {
    ...
    description: 'ISO 17100 and ISO 9001 compliant processes ensure consistent, reliable results.',
    icon: AwardIcon,
  },
]

const timeline = [
  { year: '2015', event: 'Founded in Calgary, Canada with a focus on life sciences translation.' },
  { year: '2017', event: 'Expanded services to include certified and legal translation.' },
  { year: '2019', event: 'Opened Dubai, UAE office to serve Middle East markets.' },
  { year: '2021', event: 'Achieved ISO 17100 compliance for translation services.' },
  { year: '2023', event: 'Launched software localization and multimedia services.' },
  { year: '2024', event: 'Expanded to India with Patiala office opening.' },
]
      ...
      <section className="pt-20 bg-gradient-to-br from-white via-[#F8FAFC] to-[#E0F2FE]">
        <div className="max-w-[1200px] mx-auto px-8 py-24">
          <div className="max-w-3xl">
            ...
            >
              Since 2015, we&apos;ve been helping businesses communicate across cultures with precision, quality, and speed.
            </motion.p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-slate-600">
                <p>
                  Cethos was founded in 2015 with a simple mission: to bridge language barriers with precision and cultural understanding. What started as a small team of passionate linguists has grown into a global translation company serving clients in over 100 countries.
                </p>
                <p>
