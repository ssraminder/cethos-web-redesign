      ...
      <section className="relative pt-20 bg-[#0C2340] overflow-hidden">
        ...
        <Container>
          <div className="relative max-w-3xl mx-auto text-center py-24">
            ...
            >
              Have a question about our translation services? Our team is ready to help.
            </motion.p>
          </div>
        </Container>
      </section>
            ...
            >
              {isSubmitted ? (
                <Card className="text-center py-16">
                  ...
                  >
                    <h3 className="text-2xl font-bold text-[#0C2340] mb-3">Message Sent!</h3>
